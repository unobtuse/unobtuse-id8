...
export default function IdeasScreen({
    ...
    const handleArchive = async (idea) => {
        try {
            await api.patch(`/ideas/${idea.id}/archive`, {
                archived: !idea.is_archived
            });
            fetchIdeas();
        } catch (error) {
    ...
    const renderHeader = () => {
        ...
        return ( <
            Animated.View entering = {
                shouldAnimate ? FadeInUp.duration(400) : undefined
            } >
            <
            View style = {
                styles.header
    ...
    const renderEmpty = () => ( <
        ...
        <
        Ionicons name = {
            showArchived ? 'archive-outline' : 'bulb-outline'
        }
        size = {
            64
        }
        ...
        Text style = {
            ...
            showArchived ?
            'Archived ideas will appear here' : 'Tap the button below to capture your first idea'
        } <
        /Text> < /
        Animated.View >
    );
    ...
    return ( <
...

        {
            confirmModal.visible && ( <
                ...
                <
                TouchableOpacity style = {
                    [styles.confirmButton, styles.cancelButton, {
                        borderColor: colors.glassBorder
                    }]
                }
                onPress = {
                ...
                TouchableOpacity > <
                TouchableOpacity style = {
                    [styles.confirmButton, styles.deleteButton]
                }
                onPress = {
                    confirmDelete
                } >
