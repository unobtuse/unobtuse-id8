...
export default function OnboardingModal({ visible, onClose }) {
  ...
  const isAndroid =
    Platform.OS === "web" && /Android/.test(navigator.userAgent);
        ...
        {step === 1 && (
          ...
          >
            {Platform.OS === "web" && (
              <img
                src={logoUrl}
                style={{ width: 120, height: 45, marginBottom: 16 }}
                alt="id8"
              />
            )}
          ...
          >
            ...
            {pushSupported ? (
              ...
              >
                ...
                >
                  Push notifications require adding the app to your home screen
                  first.
                </Text>
              </View>
            )}
            ...
            <View style={styles.buttonRow}>
              ...
              >
                ...
                <Text
                  style={[styles.buttonOutlineText, { color: colors.text }]}
                >
                  Back
                </Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={[
                  styles.button,
                  { backgroundColor: colors.accent, flex: 1, marginLeft: 12 },
                ]}
                onPress={handleClose}
              >
